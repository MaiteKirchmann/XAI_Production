...
Cleandata %>% ggplot() + aes(x = ...59, y = Akz_Verhaltensabsich) + geom_point(alpha = 0.5) + geom_smooth(method = lm, color = "black") + cowplot::theme_half_open() + scale_y_continuous(limits= c(1,6), breaks = 1:6) + scale_x_continuous(limits= c(1,6), breaks = 1:6) +labs(x = "Anzahl technischer Geräte", y = "Akzeptanz von KI", title = "Vermehrte Techniknutzung und Akzeptanz von KI 
korrelieren positiv.")
